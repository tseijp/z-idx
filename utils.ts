...
export const order = (api: Record<string, number>, keys: string[]): string[] =>
        [...keys].sort((a, b) => api[a] - api[b])

export const gap = (api: Record<string, number>, seq: string[]): number =>
        seq.length < 2 ? 0 : api[seq[1]] - api[seq[0]]
